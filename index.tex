...
његова употреба.\par
Код верзије документа у електронском облику ради {\sl хиперлинк\/} до наведене стране, 
као и за све остале одреднице.
За његово преузимање потребно је скенирати {QR} код који се налази на задњој корици рада.
}
...
\begin{theindex}
  ...
  \item Ојлерова формула, \hyperpage{10}
