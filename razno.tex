...
\end{alignat*}\index{ро $(\rho)$}\index{тета $(\theta)$}%
...
добијају из {\sl Меклореновог\index{Меклорен} реда\/}\index{Меклоренов ред}
...
из једнакости \eqref{eq:lnmul} и \eqref{eq:powb}, добија\index{ln@$\ln$}
...
\begin{equation}
  ...
  \label{eq:zeuler}
\end{equation}
из које, након {\sl логаритмовања}\index{логаритмовање}, добијамо занимљиву једнакост
$$
...
$$
\slika{\includegraphics[]{log.3}}{Геометријско значење $\ln x$.\index{график}}
$$
...
\smash{\hbox{\includegraphics{log.4}}}.
