...
\link{https://mathworld.wolfram.com/Antilogarithm.html}{\WMW\ --- Antilogarithm}
...
\thispagestyle{empty}
$$
% \slika{\hbox to 0pt{\hss\includegraphics{siber.10}\hss}}{Кружни декадни логаритмар.}
\hbox to 0pt{\hss\includegraphics{siber.10}\hss}
$$\label{circlog}\index{логаритмар}%

\medskip

$$
% \slika{\hbox to 0pt{\hss\includegraphics{siber.10}\hss}}{Нит.}
\hbox to 0pt{\hss\includegraphics{siber.11}\hss}
$$
